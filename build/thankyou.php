...
<body>
	<section id="thank-you">
        <div class="row">
    		...
    		<div class="col-12">
                ...
                <p>A recruiter will review your information and reach out to you if there are any opportunities in your area that meet your qualifications. In the meantime, please visit our careers website to search our openings and create a profile: <a href="http://www.redcross.org/jobs">www.redcross.org/jobs</a>.</p>
    		</div>
        </div>
	</section>
    ...
    <div style="display:none;">
        ...
        <!-- Begin FACEBOOK conversion code -->
        <script>
        ...
        fbq('init', '514604168688705');
        fbq('track', "PageView");
        fbq('track', 'Lead');</script>
        <noscript><img height="1" width="1" style="display:none"
        src="https://www.facebook.com/tr?id=514604168688705&ev=PageView&noscript=1"
        /></noscript>
        <!-- End FACEBOOK conversion code -->

        <!-- Begin APPFEEDER/APPCAST conversion code -->
        <script type='text/javascript' src='https://click.app-cast.com/pixels/bayard3-226.js?ent=8'></script>
        <!-- End APPFEEDER/APPCAST conversion code -->
